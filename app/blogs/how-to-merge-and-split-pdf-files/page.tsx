...
export const metadata: Metadata = {
  ...
  description:
    "Combine multiple PDFs or extract specific pages quickly and securely. All processing happens on your device.",
  keywords: [
    "Merge & Split PDF Tool free",
    "no sign-up",
    "merge-and-split-pdf free no sign up",
    "ai tools",
    "privacy-first",
    "browser tools"
  ],
  openGraph: {
    ...
    description:
      "Combine multiple PDFs or extract specific pages quickly and securely. All processing happens on your device.",
    url: "https://eatbit.in/blogs/how-to-merge-and-split-pdf-files",
    siteName: "EatBit",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://eatbit.in/blogs/how-to-merge-and-split-pdf-files",
  },
    ...
    <>
      <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-28 pb-24">
        ...
        <nav className="flex items-center gap-2 text-xs text-muted-foreground mb-8" aria-label="Breadcrumb">
          ...
          <span>/</span>
          <span className="text-foreground">How to Merge and Split PDF Files Locally</span>
        </nav>
        ...
        <header className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-foreground leading-tight mb-5">
            How to Merge and Split PDF Files Locally
          </h1>
        ...
        <div className="prose-custom space-y-10 text-muted-foreground text-[15px] leading-8">
          ...
          <p>
            Welcome to the ultimate guide on using our <strong>Merge & Split PDF Tool</strong>. Combine multiple PDFs or extract specific pages quickly and securely. All processing happens on your device.
          </p>
          <p>
          ...
          <section>
            <h2 className="text-2xl font-extrabold text-foreground mb-4">Why Use Our Merge & Split PDF Tool?</h2>
            <p>
              Unlike many online tools that force you to upload files to their servers, our Merge & Split PDF Tool operates entirely within your browser. This means:
            </p>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 mt-4 space-y-2">
              <li>Navigate to the <Link href="/tools/merge-and-split-pdf" className="text-primary hover:underline">Merge & Split PDF Tool</Link> page.</li>
          ...
          <div className="border border-primary/30 bg-primary/5 p-8 text-center mt-10">
            ...
            <p className="text-sm mb-6">
              Use our Merge & Split PDF Tool securely and for free. No account, no upload, no waiting.
            </p>
            <Link
              href="/tools/merge-and-split-pdf"
