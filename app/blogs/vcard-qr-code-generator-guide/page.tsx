...
export const metadata: Metadata = {
  ...
  description:
    "Network smarter by generating a vCard QR code. Let people save your contact details straight to their phones with a simple scan.",
  keywords: [
    "vCard QR Code Generator free",
    "no sign-up",
    "vcard-qr-code-generator free no sign up",
    "ai tools",
    "privacy-first",
    "browser tools"
  ],
  openGraph: {
    ...
    description:
      "Network smarter by generating a vCard QR code. Let people save your contact details straight to their phones with a simple scan.",
    url: "https://eatbit.in/blogs/vcard-qr-code-generator-guide",
    siteName: "EatBit",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://eatbit.in/blogs/vcard-qr-code-generator-guide",
  },
    ...
    <>
      <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-28 pb-24">
        ...
        <nav className="flex items-center gap-2 text-xs text-muted-foreground mb-8" aria-label="Breadcrumb">
          ...
          <span>/</span>
          <span className="text-foreground">Share Your Contact Info Instantly with vCard QR Codes</span>
        </nav>
        ...
        <header className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-foreground leading-tight mb-5">
            Share Your Contact Info Instantly with vCard QR Codes
          </h1>
        ...
        <div className="prose-custom space-y-10 text-muted-foreground text-[15px] leading-8">
          ...
          <p>
            Welcome to the ultimate guide on using our <strong>vCard QR Code Generator</strong>. Network smarter by generating a vCard QR code. Let people save your contact details straight to their phones with a simple scan.
          </p>
          <p>
          ...
          <section>
            <h2 className="text-2xl font-extrabold text-foreground mb-4">Why Use Our vCard QR Code Generator?</h2>
            <p>
              Unlike many online tools that force you to upload files to their servers, our vCard QR Code Generator operates entirely within your browser. This means:
            </p>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 mt-4 space-y-2">
              <li>Navigate to the <Link href="/tools/vcard-qr-code-generator" className="text-primary hover:underline">vCard QR Code Generator</Link> page.</li>
          ...
          <div className="border border-primary/30 bg-primary/5 p-8 text-center mt-10">
            ...
            <p className="text-sm mb-6">
              Use our vCard QR Code Generator securely and for free. No account, no upload, no waiting.
            </p>
            <Link
