...
export const metadata: Metadata = {
  ...
  description:
    "Share your menus, resumes, and brochures effortlessly by converting your PDF links into scannable QR codes.",
  keywords: [
    "PDF QR Code Generator free",
    "no sign-up",
    "pdf-qr-code-generator free no sign up",
    "ai tools",
    "privacy-first",
    "browser tools"
  ],
  openGraph: {
    ...
    description:
      "Share your menus, resumes, and brochures effortlessly by converting your PDF links into scannable QR codes.",
    url: "https://eatbit.in/blogs/create-pdf-qr-codes-free",
    siteName: "EatBit",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://eatbit.in/blogs/create-pdf-qr-codes-free",
  },
    ...
    <>
      <article className="max-w-3xl mx-auto px-4 sm:px-6 pt-28 pb-24">
        ...
        <nav className="flex items-center gap-2 text-xs text-muted-foreground mb-8" aria-label="Breadcrumb">
          ...
          <span>/</span>
          <span className="text-foreground">How to Create PDF QR Codes for Free</span>
        </nav>
        ...
        <header className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-foreground leading-tight mb-5">
            How to Create PDF QR Codes for Free
          </h1>
        ...
        <div className="prose-custom space-y-10 text-muted-foreground text-[15px] leading-8">
          ...
          <p>
            Welcome to the ultimate guide on using our <strong>PDF QR Code Generator</strong>. Share your menus, resumes, and brochures effortlessly by converting your PDF links into scannable QR codes.
          </p>
          <p>
          ...
          <section>
            <h2 className="text-2xl font-extrabold text-foreground mb-4">Why Use Our PDF QR Code Generator?</h2>
            <p>
              Unlike many online tools that force you to upload files to their servers, our PDF QR Code Generator operates entirely within your browser. This means:
            </p>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 mt-4 space-y-2">
              <li>Navigate to the <Link href="/tools/pdf-qr-code-generator" className="text-primary hover:underline">PDF QR Code Generator</Link> page.</li>
          ...
          <div className="border border-primary/30 bg-primary/5 p-8 text-center mt-10">
            ...
            <p className="text-sm mb-6">
              Use our PDF QR Code Generator securely and for free. No account, no upload, no waiting.
            </p>
            <Link
              href="/tools/pdf-qr-code-generator"
