...
function getExplicitCandidates(width, height) {
    if (width === 478 && height === 850) {
        return [
            {
                id: 'veo-478x850-portrait-32',
                label: '478x850 portrait, 32px, margin 48',
                size: 32,
                marginRight: 48,
                marginBottom: 48,
                sourcePriority: 0,
            ...
            {
                id: 'veo-478x850-portrait-relocated-32',
                label: '478x850 portrait relocated, 32px, margin 64',
                size: 32,
                marginRight: 64,
                marginBottom: 64,
                sourcePriority: 1
